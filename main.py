...
OWNER_ID = int(os.getenv("OWNER_ID", "5591891887"))
...
def safe_handler(func):
    async def wrapper(*args, **kwargs):
        try:
            ...
            await bot.send_message(5591891887, error_text)
    return wrapper
...
BOT_NAME = os.environ.get("BOT_NAME", "Sonix Music")
...
async def start_handler(_, message):
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton(f"📢 {updates_text}", url="https://t.me/SonixUpdates")
        ],
        [
            InlineKeyboardButton(f"💬 {support_text}", url="https://t.me/SonixSupport"),
...
async def fallback_local_playback(chat_id: int, message: Message, song_info: dict):
    ...
    try:
        ...
        base_caption = (
            "<blockquote>"
            "<b>🎧 🎧 Sonix ✘ Music Streaming</b> (Local Playback)\n\n"
...
if __name__ == "__main__":
    ...
    me = bot.get_me()
    BOT_NAME = me.first_name or "Sonix Music"
